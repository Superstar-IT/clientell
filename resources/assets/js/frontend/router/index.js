...
import UserAccount from './../views/settings/Account';
import Security from './../views/settings/Security';
import DownloadApp from './../views/settings/DownloadApp';
import UserSubscription from './../views/settings/Subscription';
import UserProfile from './../views/settings/Profile';
// Plans
