  ...
  <div class="container pt-5 pb-5 page-register">
    <div class="row justify-content-center">
      <div class="col-md-8">
        ...
        <div class="card">
          <div class="card-header" v-if="user">Finish Signup</div>
          <div class="card-body">
            <b-form @submit.prevent="register">
              <div v-if="!user">
                <div class="section-title mt-0">
                  <h4>Login Details</h4>
                  <p>Enter your email address and make a password. You’ll use them to log into the ClienTell app and web site. Any info marked with * is mandatory.</p>
                </div>
              ...
              <div class="section-title">
                ...
                <p>Enter your name, address and phone number. The ClienTell app uses these to build its community of contractors. Any info marked with * is mandatory.</p>
              </div>
              ...
              >
                <b-form-input class="d-none" :state="form.errors.state('phone_number')"></b-form-input>
                <intl-tel-input
                  id="phone"
              ...
              >
                <b-form-input class="d-none" :state="form.errors.state('alt_phone_number')"></b-form-input>
                <intl-tel-input
                  id="alt_phone"
              ...
              <div class="section-title">
                <h4>Account Type</h4>
                <p>You can choose your account type</p>
              </div>
              <b-form-group
                horizontal
                class="mb-1"
                ...
                label="Promo Code"
                label-class="text-md-right"
                label-for="is_free_account"
                :invalid-feedback="form.errors.get('is_free_account')"
              >
                <b-form-select v-model="form.is_free_account" :options="accountTypeOptions1"></b-form-select>
              </b-form-group>

              <!-- <div class="section-title" v-if="config.settings.free_account_on_register_enabled"> -->
              <div class="section-title" v-if="form.is_free_account===1">
                <h4>For a limited time only, {{ config.app.name }} membership is free!</h4>
                <p>We want to build our nationwide community of contractors who build their businesses by finding clients they love. So, for a limited time, we’re making it easier than ever to join {{ config.app.name }} by making it free!</p>
                <p>
                  You’re nearly done — complete the registration process by agreeing to the terms of use below and clicking the
                  <b>Register</b> button.
                </p>
              </div>
              <template v-else>
                <div class="section-title">
                  <h4>Membership</h4>
                  <p>ClienTell memberships automatically renew at the end of each billing period. You can save money with the yearly membership!</p>
                </div>
              ...
              <div class="section-title">
                ...
                <p>
                  At ClienTell, we respect your right to privacy. Please read our
                  <a href="https://clientell.app/privacy-policy/" target="_blank">privacy policy</a> and
                  <a href="https://clientell.app/terms-of-use/" target="_blank">terms and conditions</a> and check the box below to confirm that you agree:
                </p>
              </div>
              ...
              <div class="form-group">
                <div class="custom-control custom-checkbox agree-terms">
                  ...
                  <label
                    class="custom-control-label"
                    for="agree"
                  >I have read the privacy policy and agree to the terms of use.</label>
                </div>
              </div>
...
export default {
  ...
  data() {
    return {
      ...
      accountTypeOptions1: [
        { value: 1, text: "Free Account" },
        { value: 0, text: "Paid Account" }
      ],
      accountTypeOptions: [
  ...
  computed: {
    shouldReportAnalytics() {
      return (
        this.config.app.env === "production" || this.config.app.env === "prod"
      );
    },
    states() {
  ...
  methods: {
    getCompanies() {
      window.axios.get("/api/v1/company").then(response => {
