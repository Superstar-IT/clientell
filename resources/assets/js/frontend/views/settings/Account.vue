<template>
    <div class="user-profile">
        <b-card class="">
            ...
            <div v-if="!editing" class="text-center mt-3">
            ...
            <div v-else class="text-center mt-3">
                <b-form @submit.prevent="submit">
                    ...
                    <b-form-group horizontal
                        ...
                        <b-form-input id="company_name" v-model="form.company_name" :state="form.errors.state('company_name')"></b-form-input>
                    </b-form-group>
                    <b-form-group horizontal
                                label-cols="4"
                                breakpoint="md"
    ...
    export default {
        ...
        data() {
            return {
                ...
                accountTypeOptions: [
                    ...
                    { value: AccountType.ACCOUNT_TYPE_COMPANY, text: "Organization" }
                ],
            }
        },
        computed: {
        ...
        methods: {
            edit() {
                ...
                this.editing = true;
                window.$.extend(this.form, window._.pick(this.user, ['first_name', 'last_name', 'middle_name', 'street_address', 'street_address2', 'city', 'state', 'email', 'business_url', 'twitter_url', 'facebook_url', 'phone_number', 'phone_number_ext', 'alt_phone_number', 'alt_phone_number_ext', 'description', 'country_id','account_type']));
            },
